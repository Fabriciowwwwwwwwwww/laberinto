...
class_name Puerta
var next_scene_path: PackedScene = preload("res://scenes/quests/story_quests/template_laberinto/1_template_stealth_laberinto/Mundo/main_2.tscn")
...
func check_door_status()->void:
	...
	if player_keys >= 10 and not is_unlocked:
		unlock_door()
	elif player_keys <10:
...
func show_locked_ui(current_keys: int)->void:
	ui_container.visible = true
	interact_label.text = "Consigue " + str(10 - current_keys) + " llaves más"
