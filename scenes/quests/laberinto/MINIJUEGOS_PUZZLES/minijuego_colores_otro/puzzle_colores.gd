...
func mostrar_solo_referencia():
	...
	# centrar referencia
	$CanvasLayer/referencia.position = Vector2(600, 120)
...
func iniciar_ronda():
	...
	cinematica.set_solucion(solucion)
	cinematica.set_escena_solucion(escena_actual)
